...
import com.train.app.config.ApplicationProperties;
import com.train.app.config.DefaultProfileUtil;
...
public class TrainApp {
    ...
    public TrainApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes TrainApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TrainApp.class);
